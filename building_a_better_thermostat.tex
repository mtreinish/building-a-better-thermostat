...
\section{Conclusions}
\begin{frame}
    \frametitle{State of Apartment Automation}
    \centering
    \includegraphics[height=.95\textheight]{HA_apartment.png}
\end{frame}
...
\frametitle{Where to get more information}
    \begin{itemize}
        ...
        \item Slides: \href{https://github.com/mtreinish/building-a-better-thermostat/tree/seagl2017}{https://github.com/mtreinish/building-a-better-thermostat/tree/seagl2017}
    \end{itemize}
\end{frame}
