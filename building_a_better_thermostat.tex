...
\author[Matthew Treinish]{%
    \texorpdfstring{%
        ...
        \href{https://github.com/mtreinish/building-a-better-thermostat/tree/openwest2017}{https://github.com/mtreinish/building-a-better-thermostat/tree/openwest2017}
   }
   {Matthew Treinish}
}
\date{July 13, 2017}
...
\begin{frame}
    \frametitle{Environment based Rules}
    \begin{itemize}
        \item Home assistant has a lot of data about your environment
        \item You can leverage this data to automate in interesting ways
    \end{itemize}
\end{frame}
