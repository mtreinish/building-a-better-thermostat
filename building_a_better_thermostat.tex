...
\author[Matthew Treinish]{%
    \texorpdfstring{%
        ...
        \href{https://github.com/mtreinish/building-a-better-thermostat/tree/fossc-2019}{https://github.com/mtreinish/building-a-better-thermostat/tree/fossc-2019}
   }
   {Matthew Treinish}
}
...
\begin{frame}
    ...
    \end{center}
    \begin{itemize}
        \item Air conditioner on for 8 min. and off for 4 min.
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Living Room on for 20 min. off for 29 min.
    \end{itemize}
\end{frame}
...
\frametitle{Where to get more information}
    \begin{itemize}
        ...
        \item Slides: \href{https://github.com/mtreinish/building-a-better-thermostat/tree/fossc-2019}{https://github.com/mtreinish/building-a-better-thermostat/tree/fossc-2019}
    \end{itemize}
\end{frame}
